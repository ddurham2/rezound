...
#ifndef __CMIDISDSSoundTranslator_H__
#define __CMIDISDSSoundTranslator_H__

#include "../../config/common.h"

#include "ASoundTranslator.h"

class CMIDISDSSoundTranslator : public ASoundTranslator
{
public:
	CMIDISDSSoundTranslator();
	virtual ~CMIDISDSSoundTranslator();
