...
#ifndef __playcontrols_H__
#define __playcontrols_H__
...
#define DEFAULT_SEEK_DISTANCE 3192
...
/*
void seekBack(ASoundFileManager *soundFileManager,int distance=DEFAULT_SEEK_DISTANCE);
void seekForward(ASoundFileManager *soundFileManager,int distance=DEFAULT_SEEK_DISTANCE);
void selectSeekBack(ASoundFileManager *soundFileManager,int distance=DEFAULT_SEEK_DISTANCE);
void selectSeekForward(ASoundFileManager *soundFileManager,int distance=DEFAULT_SEEK_DISTANCE);
*/
