...
CProgressDialog::CProgressDialog(FXWindow *owner,const FXString &title/*,bool showCancelButton*/) :
	...
	contents(new FXHorizontalFrame(this,LAYOUT_FILL_X|LAYOUT_FILL_Y | FRAME_RAISED|FRAME_THICK, 0,0,0,0, 6,6,6,6, 2,2)),
		...
		//cancelButton(!showCancelButton ? NULL : new FXButton(buttonPacker,"&Cancel",new FXGIFIcon(getApp(),RedX1),this,ID_CANCEL,FRAME_RAISED|FRAME_THICK | JUSTIFY_NORMAL | ICON_ABOVE_TEXT | LAYOUT_FIX_WIDTH, 0,0,60,0, 2,2,2,2))
{
