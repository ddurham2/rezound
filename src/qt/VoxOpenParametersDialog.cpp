...
VoxOpenParametersDialog::VoxOpenParametersDialog(QWidget *mainWindow) :
	ActionParamDialog(mainWindow)
{
	...
	m_channels=addComboTextEntry(p,N_("Channels:"),ch,ActionParamDialog::cpvtAsInteger,"",false);
	...
	m_sampleRate=addComboTextEntry(p,N_("Sample Rate:"),br,ActionParamDialog::cpvtAsInteger,"",true);
	m_sampleRate->setIntegerValue(44100);
			
}

bool VoxOpenParametersDialog::show(AFrontendHooks::VoxParameters &parameters)
{
