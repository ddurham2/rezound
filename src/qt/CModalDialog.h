...
#ifndef __CModalDialog_H__
#define __CModalDialog_H__
 ...
 */
#include "ui_CModalDialog.h"
class CModalDialog : public QDialog, private Ui::CModalDialog
{
	Q_OBJECT
public:
	...
	CModalDialog(QWidget *parent,const QString title/*,int w,int h*/,FrameTypes frameType=ftHorizontal,ShowTypes showType=stRememberSizeAndPosition);
