...
CTransportWindow::CTransportWindow(QWidget *parent, Qt::WindowFlags flags) :
...
void CTransportWindow::setMainWindow(CMainWindow *mainWindow)
{
...
bool CTransportWindow::eventFilter(QObject *watched, QEvent *event)
{
...
void CTransportWindow::on_playAllButton_clicked()
{
...
void CTransportWindow::on_playAllLoopedButton_clicked()
{
	m_mainWindow->levelMeters()->resetGrandMaxPeakLevels();
	play(gSoundFileManager,CSoundPlayerChannel::ltLoopNormal,false);
}

void CTransportWindow::on_playSelectionOnceButton_clicked()
{
	m_mainWindow->levelMeters()->resetGrandMaxPeakLevels();
	play(gSoundFileManager,CSoundPlayerChannel::ltLoopNone,true);
}

void CTransportWindow::on_playFromStartPositionButton_clicked()
{
	m_mainWindow->levelMeters()->resetGrandMaxPeakLevels();
...
void CTransportWindow::on_playSelectionLoopedButton_clicked()
{
	m_mainWindow->levelMeters()->resetGrandMaxPeakLevels();
	play(gSoundFileManager,CSoundPlayerChannel::ltLoopNormal,true);
}

void CTransportWindow::on_playSelectionLoopedSkipMostButton_clicked()
{
	m_mainWindow->levelMeters()->resetGrandMaxPeakLevels();
	play(gSoundFileManager,CSoundPlayerChannel::ltLoopSkipMost,true);
}

void CTransportWindow::on_playSelectionLoopedGapBeforeRepeatButton_clicked()
{
	m_mainWindow->levelMeters()->resetGrandMaxPeakLevels();
	play(gSoundFileManager,CSoundPlayerChannel::ltLoopGapBeforeRepeat,true);
}

void CTransportWindow::on_playFromLeftEdgeOfScreenToEndButton_clicked()
{
...
void CTransportWindow::on_stopButton_clicked()
{
	stop(gSoundFileManager);
}

void CTransportWindow::on_pauseButton_clicked()
{
	pause(gSoundFileManager);
}

void CTransportWindow::on_recordButton_clicked()
{
...
void CTransportWindow::on_jumpToBeginningButton_clicked()
{
	jumpToBeginning(gSoundFileManager);
}

void CTransportWindow::on_jumpToStartPositionButton_clicked()
{
	jumpToStartPosition(gSoundFileManager);
}

void CTransportWindow::on_jumpToPrevCueButton_clicked()
{
	jumpToPreviousCue(gSoundFileManager);
}

void CTransportWindow::on_jumpToNextCueButton_clicked()
{
	jumpToNextCue(gSoundFileManager);
}

void CTransportWindow::on_shuttleDial_sliderReleased()
{
...
void CTransportWindow::on_shuttleDial_valueChanged(int value)
{
...
void CTransportWindow::on_shuttleSpringButton_toggled(bool checked)
{
...
void CTransportWindow::on_shuttleScaleButton_clicked()
{
