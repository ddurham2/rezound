...
#include "ui_RecordDialogContent.h"
class RecordDialog : public ModalDialog, private Ui::RecordDialogContent
{
	Q_OBJECT
public:
	RecordDialog(QWidget *parent) :
		ModalDialog(parent,_("Record"))
	{
		Ui::RecordDialogContent::setupUi(getFrame());

		levelMeters=new RecordLevelMeters(metersFrame);
