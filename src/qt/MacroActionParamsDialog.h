...
#include "ui_MacroActionParamsDialogContent.h"
class MacroActionParamsDialog : public ModalDialog, private Ui::MacroActionParamsDialogContent
{
public:
	MacroActionParamsDialog(QWidget *parent) :
        ModalDialog(parent,_("Macro Action Parameters"))
	{
		Ui::MacroActionParamsDialogContent::setupUi(getFrame());
		QMetaObject::connectSlotsByName(this);
	}

	virtual ~MacroActionParamsDialog()
	{
	}
