...
RawParametersDialog::RawParametersDialog(QWidget *mainWindow) :
	ActionParamDialog(mainWindow)
{
	...
	QWidget *p=newVertPanel(NULL);
		...
		channelsCombo=addComboTextEntry(p,N_("Channels:"),channels,ActionParamDialog::cpvtAsInteger,"",true);
		...
		sampleRateCombo=addComboTextEntry(p,N_("Sample Rate:"),sampleRates,ActionParamDialog::cpvtAsInteger,"",true);
		...
		sampleFormatCombo=addComboTextEntry(p,N_("Sample Format"),sampleFormats,ActionParamDialog::cpvtAsInteger,"");
		...
		endianCombo=addComboTextEntry(p,N_("Byte Order:"),endians,ActionParamDialog::cpvtAsInteger,"");
...
bool RawParametersDialog::show(AFrontendHooks::RawParameters &parameters,bool showLoadRawParameters)
{
