...
#include "ui_CNewSoundDialogContent.h"
class CNewSoundDialog : public CModalDialog, private Ui::CNewSoundDialogContent
{
	Q_OBJECT
public:
	CNewSoundDialog(QWidget *parent) :
		CModalDialog(parent,_("New Sound"))
	{
		Ui::CNewSoundDialogContent::setupUi(getFrame());
