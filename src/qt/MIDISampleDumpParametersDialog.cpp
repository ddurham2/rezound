...
MIDISampleDumpParametersDialog::MIDISampleDumpParametersDialog(QWidget *mainWindow) :
...
bool MIDISampleDumpParametersDialog::showForOpen(int &sysExChannel,int &waveformId)
{
...
bool MIDISampleDumpParametersDialog::showForSave(int &sysExChannel,int &waveformId,int &loopType)
{
	CActionParameters actionParameters(NULL);
...
void MIDISampleDumpParametersDialog::onWaitForDumpCheckBox_changed()
{
