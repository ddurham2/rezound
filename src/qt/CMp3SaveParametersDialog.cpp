...
CMp3SaveParametersDialog::CMp3SaveParametersDialog(QWidget *mainWindow) :
	CActionParamDialog(mainWindow)
{
	...
	QWidget *p=newVertPanel(NULL);
		...
		p->layout()->addWidget(CBRGroupBox);
			CBRCombo=addComboTextEntry(CBRGroupBox,N_("Bit Rate:"),br,CActionParamDialog::cpvtAsInteger,"");
		...
		p->layout()->addWidget(ABRGroupBox);
			minABRCombo=addComboTextEntry(ABRGroupBox,N_("Minimum Bit Rate:"),br,CActionParamDialog::cpvtAsInteger,"");
			minABRCombo->setIntegerValue(9);
			normalABRCombo=addComboTextEntry(ABRGroupBox,N_("Normal Bit Rate:"),br,CActionParamDialog::cpvtAsInteger,"");
			normalABRCombo->setIntegerValue(9);
			maxABRCombo=addComboTextEntry(ABRGroupBox,N_("Maximum Bit Rate:"),br,CActionParamDialog::cpvtAsInteger,"");
...
void CMp3SaveParametersDialog::onGroupBoxToggled(bool on)
{
	if(!on)
...
void CMp3SaveParametersDialog::onUseOnlyFlagsCheckBox_changed()
{
...
bool CMp3SaveParametersDialog::show(AFrontendHooks::Mp3CompressionParameters &parameters)
{
