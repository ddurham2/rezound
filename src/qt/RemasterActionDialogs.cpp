	...
	CActionParamDialog(mainWindow,false)
{
	...
	p0->layout()->addWidget(p1);

		QWidget *p2=newHorzPanel(NULL);
		p1->addTab(p2,_("Pitch"));
			addSlider(
				p2,
				N_("Semitones"),
				_("semitones"),
