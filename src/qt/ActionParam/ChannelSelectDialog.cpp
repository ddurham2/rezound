...
ChannelSelectDialog *gChannelSelectDialog=NULL;


// ----------------------------------------

ChannelSelectDialog::ChannelSelectDialog(QWidget *mainWindow) :
/*
 ...
 *
 * this goes for derivations of ModalDialog and all action param value widgets
 *
 * ??? I *think* I can make this _() instead of N_() on the title.. I don't call getTitle() anywhere
 */
	ModalDialog(mainWindow,N_("Channel Select")/*,100,100*/,ModalDialog::ftVertical)
{
...
bool ChannelSelectDialog::show(CActionSound *actionSound,CActionParameters *actionParameters)
{
...
void ChannelSelectDialog::hide()
{
	ModalDialog::hide();
}

void ChannelSelectDialog::onDefaultButton()
{
	onClearButton();
...
void ChannelSelectDialog::onClearButton()
{
