...
#ifndef __ChannelSelectDialog_H__
#define __ChannelSelectDialog_H__
...
class ChannelSelectDialog;

#include "../ModalDialog.h"
#include "ui_ChannelSelectDialogContent.h"

#include "../../backend/AActionDialog.h"
#include "../../backend/CActionSound.h"

extern ChannelSelectDialog *gChannelSelectDialog;

#warning see about getting this put into a tab on all applicable ActionParamDialogs .. there may be a challenge if the selection of channels comes first and then that determines how the action param dialog looks.. I could use a wizard style dialog for that
/*
 ...
 * on the dialog
 */
class ChannelSelectDialog : public ModalDialog, public AActionDialog
{
	Q_OBJECT
public:
    ChannelSelectDialog(QWidget *mainWindow);
...
private:
	Ui::ChannelSelectDialogContent csdc;
