...
#ifndef __CComboTextParamValue_H__
#define __CComboTextParamValue_H__

#include "../../../config/common.h"
#include "../qt_compat.h"

#include "ui_CComboTextParamValue.h"
...
class CComboTextParamValue : public QWidget, public Ui::CComboTextParamValue
{
	Q_OBJECT
public:
	CComboTextParamValue(const char *name,const vector<string> &items,bool isEditable);
	virtual ~CComboTextParamValue();
