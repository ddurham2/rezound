...
#ifndef __CDiskEntityParamValue_H__
#define __CDiskEntityParamValue_H__

#include "../../../config/common.h"
#include "../qt_compat.h"

#include "ui_CDiskEntityParamValue.h"
...
class CDiskEntityParamValue : public QWidget, public Ui::CDiskEntityParamValue
{
	Q_OBJECT
public:
	...
	CDiskEntityParamValue(const char *name,const string initialEntityName,DiskEntityTypes entityType);
	virtual ~CDiskEntityParamValue();
