...
#ifndef __CGraphParamValue_H__
#define __CGraphParamValue_H__
...
#include "CSoundWindow.h" // for IWaveDrawing and drawWaveRuler()
class CGraphParamValue : public IWaveDrawing, public Ui::CGraphParamValue
{
	Q_OBJECT
public:
	CGraphParamValue(const char *name);
	virtual ~CGraphParamValue();
	...
	void copyFrom(const CGraphParamValue *src);
	void swapWith(CGraphParamValue *src);
