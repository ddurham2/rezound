...
ConstantParamValue::ConstantParamValue(AActionParamMapper *_valueMapper,bool showInverseButton,const char *_name) :
	name(_name),
...
ConstantParamValue::~ConstantParamValue()
{
}

void ConstantParamValue::setMinSize(int minWidth,int minHeight)
{
	setMinimumSize(minWidth,minHeight);
}

void ConstantParamValue::setUnits(const string units)
{
...
void ConstantParamValue::on_slider_valueChanged(int value)
{
...
void ConstantParamValue::on_scalarSpinner_valueChanged(int value)
{
...
void ConstantParamValue::on_valueTextBox_editingFinished()
{
...
void ConstantParamValue::on_inverseButton_clicked()
{
...
void ConstantParamValue::updateNumbers()
{
...
const double ConstantParamValue::getValue() const
{
	return retValue;
}

void ConstantParamValue::setValue(const double value)
{
	defaultValue=value;
	prvSetValue(value);
}

void ConstantParamValue::prvSetValue(const double value)
{
	retValue=value;
...
const int ConstantParamValue::getScalar() const
{
	return valueMapper->getScalar();
}

void ConstantParamValue::setScalar(const int scalar)
{
...
const int ConstantParamValue::getMinScalar() const
{
	return scalarSpinner->minimum();
}

const int ConstantParamValue::getMaxScalar() const
{
	return scalarSpinner->maximum();
}

const string ConstantParamValue::getName() const
{
	return name;
}

void ConstantParamValue::setTipText(const string &_text)
{
...
string ConstantParamValue::getTipText() const
{
	return toolTip().toStdString();
}

void ConstantParamValue::enable()
{
	setEnabled(true);
}

void ConstantParamValue::disable()
{
	setEnabled(false);
}

void ConstantParamValue::readFromFile(const string &prefix,CNestedDataFile *f)
{
...
void ConstantParamValue::writeToFile(const string &prefix,CNestedDataFile *f) const
{
	const string key=prefix DOT getName();
