...
PasteChannelsDialog *gPasteChannelsDialog=NULL;
...
PasteChannelsDialog::PasteChannelsDialog(QWidget *mainWindow) :
	ModalDialog(mainWindow,N_("Paste Channels")/*,100,100*/,ModalDialog::ftVertical)
{
	...
	repeatCountSlider=new ConstantParamValue(
	...
	repeatTimeSlider=new ConstantParamValue(
...
PasteChannelsDialog::~PasteChannelsDialog()
{
}

bool PasteChannelsDialog::show(CActionSound *_actionSound,CActionParameters *actionParameters)
{
...
void PasteChannelsDialog::hide()
{
	ModalDialog::hide();
}

void *PasteChannelsDialog::getUserData()
{
	return &pasteChannels;
}


void PasteChannelsDialog::onDefaultButton()
{
	onClearButton();
...
void PasteChannelsDialog::onClearButton()
{
	for(unsigned row=0;row<MAX_CHANNELS;row++)
	for(unsigned col=0;col<MAX_CHANNELS;col++)
