...
#include "ui_PluginRoutingParamValue.h"
...
class PluginRoutingParamValue : public QWidget, public Ui::PluginRoutingParamValue
{
	Q_OBJECT
public:
	PluginRoutingParamValue(const char *name,const LADSPA_Descriptor *desc);
	virtual ~PluginRoutingParamValue();
...
private:
	...
	struct REntity // ??? I might ought to have subclasses of this for RSourceEntity, RInstanceEntity and ROutputEntity types
	{
		...
		PluginRoutingParamValue *paramValue;
...
*/
		...
		REntity(PluginRoutingParamValue *_paramValue,QWidget *_window) :
