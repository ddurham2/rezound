...
CPluginRoutingParamValue::CPluginRoutingParamValue(const char *_name,const LADSPA_Descriptor *_desc) :
	name(_name),
	pluginDesc(_desc),
	actionSound(NULL),
...
CPluginRoutingParamValue::~CPluginRoutingParamValue()
{
}
 ...
 */
void CPluginRoutingParamValue::REntity::RNode::getPosition(QWidget *canvas,int &x,int &y)
{
...
void CPluginRoutingParamValue::REntity::RNode::draw(QPainter &p)
{
...
void CPluginRoutingParamValue::drawSolidNode(QPainter &p,const RNodeDesc &desc)
{
	REntity *entity;
	REntity::RNode *node;
...
int CPluginRoutingParamValue::findNearestHoleWithinInstancesColumn(int instanceX,int fromx,int fromy)
{
...
void CPluginRoutingCanvas::paintEvent(QPaintEvent *ev) { prpv->drawCanvas(ev); }

void CPluginRoutingParamValue::drawCanvas(QPaintEvent *e)
{
	QPainter p(canvas);
...
bool CPluginRoutingParamValue::isValidConnection(const RNodeDesc &desc1,const RNodeDesc &desc2)
{
	if(desc1==desc2)
		return false;
...
void CPluginRoutingParamValue::mouseMoveEvent(QMouseEvent *ev)
{
	int x=ev->x();
	int y=ev->y();
...
void CPluginRoutingParamValue::mousePressEvent(QMouseEvent *ev)
{
	int x=ev->x();
	int y=ev->y();
...
void CPluginRoutingParamValue::mouseReleaseEvent(QMouseEvent *ev)
{
...
void CPluginRoutingParamValue::onConnectionGainChanged(int v)
{
	float g=v/100.0;
...
void CPluginRoutingParamValue::onResetConnectionGain()
{
	connectionGainSlider->setValue(100);
}

void CPluginRoutingParamValue::resizeEvent(QResizeEvent *e)
{
	initialLayout();
}

const CPluginMapping CPluginRoutingParamValue::getValue() const
{
	CPluginMapping ret;
...
const string CPluginRoutingParamValue::getName() const
{
	return name;
}

void CPluginRoutingParamValue::setSound(CSound *_actionSound)
{
	/* 
...
void CPluginRoutingParamValue::prvSetSound(CSound *_actionSound)
{
	actionSound=_actionSound;
...
void CPluginRoutingParamValue::createOutput()
{
...
void CPluginRoutingParamValue::createOutputChannel()
{
...
void CPluginRoutingParamValue::removeOutputChannel()
{
...
void CPluginRoutingParamValue::newInstance()
{
...
void CPluginRoutingParamValue::newSource(CLoadedSound *loaded,size_t soundFileManagerIndex)
{
...
void CPluginRoutingParamValue::initialLayout()
{
	#define PADDING 20
...
bool CPluginRoutingParamValue::findNode(const RNodeDesc &desc,REntity *&entity,REntity::RNode *&node) const
{
...
CPluginRoutingParamValue::REntity *CPluginRoutingParamValue::findEntity(const RNodeDesc &desc) const
{
	switch(desc.family)
	{
 ...
 */
bool CPluginRoutingParamValue::whereNode(int x,int y,RNodeDesc &desc)
{
	// check sources
	for(size_t t=0;t<N_sources.size();t++)
	{
...
void CPluginRoutingParamValue::on_newInstanceButton_clicked()
{
	newInstance();
	initialLayout();
	//scrollArea->recalc();
...
void CPluginRoutingParamValue::on_useSoundButton_clicked()
{
...
void CPluginRoutingParamValue::removeEntity(vector<REntity> &familyMembers,RNodeDesc::Families family,QWidget *entity)
{
...
bool CPluginRoutingParamValue::eventFilter(QObject *watched,QEvent *e)
{
...
void CPluginRoutingParamValue::on_clearButton_clicked()
{
...
void CPluginRoutingParamValue::on_defaultButton_clicked()
{
...
void CPluginRoutingParamValue::guessAtRouting()
{
#ifdef ENABLE_LADSPA
...
void CPluginRoutingParamValue::clearAll()
{
	draggingWire=false;
	mouseIsOverNode=false;
...
void CPluginRoutingParamValue::resetSoundList()
{
	soundList->clear();
...
void CPluginRoutingParamValue::readFromFile(const string &prefix,CNestedDataFile *f)
{
	RESET_WIRE_COLOR
...
void CPluginRoutingParamValue::writeToFile(const string &prefix,CNestedDataFile *f) const
{
	/*
