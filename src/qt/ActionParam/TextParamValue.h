...
#include "ui_TextParamValue.h"

#include <string>

class CNestedDataFile;

class TextParamValue : public QWidget, public Ui::TextParamValue
{
	Q_OBJECT
public:
    TextParamValue(const char *name,const double initialValue,const double minValue,const double maxValue); // make it behave as a numeric entry
    TextParamValue(const char *name,const string initialValue); // make it behave like a text entry
    virtual ~TextParamValue();
